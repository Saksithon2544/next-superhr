...
// import { ReactComponent as ErrorOutline } from './assets/images/_ErrorOutline.svg';
import WarningAmberOutlined  from '../images/_WarningAmberOutlined.svg';
import InfoOutlined from '../images/_InfoOutlined.svg';
import CheckCircleOutlined from '../images/_CheckCircleOutlined.svg';
import CheckBoxOutlineBlank from '../images/_CheckBoxOutlineBlankOutlined.svg';
import IndeterminateCheckBo from '../images/_IndeterminateCheckBoxFilled.svg';
import CheckBoxFilled from '../images/_CheckBoxFilled.svg';
...
const questTheme = createTheme(
  {
    components: {
      ...
      MuiAlert: {
        defaultProps: {
          iconMapping: {
            error: <img src={CheckBoxFilled} alt="" />,
            warning: <img src={WarningAmberOutlined} alt="" />,
            info: <img src={InfoOutlined} alt="" />,
            success: <img src={CheckCircleOutlined} alt="" />,
          },
        },
        styleOverrides: {
          filledError: {
      ...
      MuiCheckbox: {
        defaultProps: {
          icon: <img src={CheckBoxOutlineBlank} alt="" />,
          indeterminateIcon: <img src={IndeterminateCheckBo} alt="" />,
          checkedIcon: <img src={CheckBoxFilled} alt="" />,
        },
        styleOverrides: {
          root: {
            '&:hover': {
