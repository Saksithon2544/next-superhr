...
const ConfirmInfoRegisterJobSeeker = ({ formData }) => {
    ...
    const handleConfirm = () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                data.append('startDate', formData.application.startDate);
                data.append('expectedSalary', formData.application.expectedSalary);
                data.append('lastestSalary', formData.application.lastestSalary);
            ...
            <div style={{ margin: '20px' }}>
                ...
                <Card className="mt-4 p-4">
                    ...
                    <Card.Body className={styles.custom_card_body}>
                        ...
                        <p>
                            <b>Start Date:</b> {formData.application.startDate}
                        </p>
                        <p>
                            <b>Expected Salary:</b> {formData.application.expectedSalary}
                        </p>
                        <p>
                            <b>Lastest Salary:</b> {formData.application.lastestSalary}
                        </p>
                        <p>
...
export default ConfirmInfoRegisterJobSeeker;
