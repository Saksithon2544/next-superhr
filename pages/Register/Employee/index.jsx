...
import ConfirmInfo from '../../ConfirmInfoRegister/Employee';
  ...
  return (
    <Container>
      <div style={{ margin: '50px' }}>
        ...
        {step === 2 && (
          <div>
            <Employee2 onNext={nextStep} formData={formData} setFormData={setFormData} />
          </div>
        )}

        {step === 3 && (
          <div>
            <Employee3 onNext={nextStep} formData={formData} setFormData={setFormData} />
          </div>
        )}

        {step === 4 && (
          <div>
            <Employee4 onNext={nextStep} formData={formData} fileNames={formData.fileNames} setFormData={setFormData} />
          </div>
        )}
