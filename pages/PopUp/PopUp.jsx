...
function PopUp(props) {
  return (
    <PopUp1 className={props.className}>
      <Create>
        <Frame184>
          <PlusCircle>
      ...
      <Line7 src={Line7Image} loading="lazy" alt={'Line 7'} />
      <Frame128>
        <IcBaselineStar>
